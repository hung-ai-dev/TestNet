...
if __name__ == "__main__":
    ...
    dataloaders = {
        "train": torch.utils.data.DataLoader(image_datasets['train'], batch_size=46, shuffle=True, pin_memory=False, num_workers=8),
        "val": torch.utils.data.DataLoader(image_datasets['val'], batch_size=2, shuffle=True, pin_memory=False, num_workers=8)
    }
