...
if __name__ == "__main__":
    ...
    dataloaders = {
        "train": torch.utils.data.DataLoader(image_datasets['train'], batch_size=64, shuffle=True, pin_memory=True, num_workers=16),
        "val": torch.utils.data.DataLoader(image_datasets['val'], batch_size=1, shuffle=True, pin_memory=True, num_workers=16)
    }
